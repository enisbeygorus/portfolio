  ...
  return (
    <div className="block sm:flex gap-0 sm:gap-10 mt-14">
      <div className="w-full sm:w-1/3 text-left">
        {/* Project Image */}
        {singleProjectData.ProjectImages ? (
          <div
            className="mb-10 sm:mb-7 aspect-square"
            key={singleProjectData.ProjectImages[0].id}
          >
            <img
              src={singleProjectData.ProjectImages[0].img}
              className="w-full h-full rounded-xl shadow-lg sm:shadow-none object-cover"
              alt={singleProjectData.ProjectImages[0].title}
              key={singleProjectData.ProjectImages[0].id}
            />
          </div>
        ) : null}
